...
if __name__ == '__main__':
    ...
    root.geometry("600x150")  # 设置窗口大小  并初始化桌面位置
    ...
    def callListbox(event):
        if lb3.selection_includes(END):
            lb3.select_clear(END)
        # lb3.config(lb3.selection_set(0, 2))
        print(lb3.selection_includes(END))
        # lb3.select_clear(END)
        # print(lb3.curselection())
