...
class tl12306(object):
    '''
    12306车票监控，目前支持1等座 2等座 无座，监控结果以邮件发送或者方糖微信推送
    '''
    def __init__(self):
        # 创建主窗口,用于容纳其它组件
    ...
    def get_station_code(self):
        ...
        result = {}
        result['from_code'] = ''  # 起点站的拼音编码
        result['to_code'] = ''   # 终点站的拼音编码
        try:
    ...
    def getlist(self):
        ...
        self.url = 'https://kyfw.12306.cn/otn/leftTicket/query?leftTicketDTO.train_date={}&leftTicketDTO.from_station={}&leftTicketDTO.to_station={}&purpose_codes=ADULT'
        self.headers = {
            "Host": "kyfw.12306.cn",
            "If-Modified-Since": "0",
            ...
            try:
                ...
                if  r.status_code == 200:
                    ...
                    for r in k['result']:
                        ...
                        # seat1 = str(strarray[-7])  # 一等座
                        # seat2 = str(strarray[-8])  # 二等座
                        # seat3 = str(strarray[-12])  # 站票
                        seat1 = str(strarray[-8])  # 一等座
                        seat2 = str(strarray[-9])  # 二等座
                        seat3 = str(strarray[-13])  # 站票
