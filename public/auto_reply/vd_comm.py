...
def vd_comm(action_dict, eleme_sign_dict, url_sc_dict, fromUser, text, state):
    ...
    r = {'code': 0, 'msg': ''}
    # 20201030王者壁纸王者语音包获取修改为王者菜单查询
    if text == '001' or text == '王者荣耀皮肤壁纸' or text == '王者荣耀壁纸' or text == '王者壁纸' or text == '王者荣耀' or text == '王者':
        action_dict[fromUser] = 'wzry'
        rs = pubVarList.objects.filter(var_name='WZ_PUB_MENU')[0].var_info.replace('|', '\n') + END_STR
        r['msg'] = rs
        return r
    ...
    #     r['msg'] = rs
    #     return r
    elif text == '002' or text == '英雄联盟皮肤壁纸' or text == '英雄联盟壁纸' or text == '联盟壁纸' or text == 'LOL壁纸'or text == 'lol壁纸':
        action_dict[fromUser] = 'yxlm_bz'
        rs = '获取英雄联盟壁纸：\n\n请在5分钟内回复你要的英雄名字或皮肤关键字哦~ 需要全英雄请回复all'+END_STR
        r['msg'] = rs
        return r
    elif text == '003' or text == '饿了么红包':
